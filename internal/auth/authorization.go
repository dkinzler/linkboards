...
// directly in the components that use them.
...
const (
	...
	// These roles are shared across components of this app, since most of them require authorization relative to boards.
	// E.g. whether or not a user is authorized to invite other users, add/delete links or
	// post/delete comments to a board depends on the roles the user has for that particular board.
...
type Authorization map[Scope]struct{}
...
// AuthorizationStore can be used to get a user's roles for a board.
